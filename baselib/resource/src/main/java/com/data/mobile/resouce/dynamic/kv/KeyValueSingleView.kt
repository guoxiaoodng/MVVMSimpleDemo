...
import com.data.mobile.resouce.extend.StringExtend
...
class KeyValueSingleView : LinearLayoutCompat, View.OnClickListener {
     ...
     * 业务中非编辑状态 才会去设置 此值
     */
    fun setValueDrawableRight(d: Drawable) {
     ...
     * 业务中非编辑状态 才会去设置 此值
     */
    fun setValueDrawableLeft(d: Drawable) {
        valueView?.compoundDrawablePadding = 10
     ...
     * 设置key的drawable
     */
    fun setKeyDrawableLeft(d: Drawable) {
     ...
     * 设置key的drawable
     */
    fun setKeyDrawableRight(d: Drawable) {
