...
import com.data.mobile.net.constance.http.HttpWay
import com.data.mobile.resouce.arouter.guest.BehaviorEnum
import org.jetbrains.annotations.NotNull

class CommonListManager<B : Parcelable>(
    /**行为类型 [BehaviorEnum]*/
    ...
    constructor(
        ...
        @NotNull
        itemLayout: Int,
        requestMap: MutableMap<String, Any> = mutableMapOf(),
        @DrawableRes
        divider: Int = -1,
        dividerWidth: Int = 10,
        pageInit: Int = 1,
