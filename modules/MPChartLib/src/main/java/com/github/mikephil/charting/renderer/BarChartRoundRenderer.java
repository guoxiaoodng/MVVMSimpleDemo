...
public class BarChartRoundRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    public BarChartRoundRenderer(BarDataProvider chart, ChartAnimator animator,
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        if (mChart.isDrawBarShadowEnabled()) {
            ...
            for (int i = 0, count = Math.min((int) (Math.ceil((float) (dataSet.getEntryCount()) * phaseX)), dataSet.getEntryCount());
                ...
                c.drawRoundRect(mBarShadowRectBuffer, (mBarShadowRectBuffer.right - mBarShadowRectBuffer.left) / 2,
                        (mBarShadowRectBuffer.right - mBarShadowRectBuffer.left) / 2, mShadowPaint);
            }
        }
