...
public abstract class DataRenderer extends Renderer {
    ...
    protected Paint mRenderBackgroundPaint;
    ...
    public DataRenderer(ChartAnimator animator, ViewPortHandler viewPortHandler) {
        ...
        mRenderBackgroundPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mRenderBackgroundPaint.setStyle(Style.FILL);
        mRenderBackgroundPaint.setColor(Color.parseColor("#999999"));
