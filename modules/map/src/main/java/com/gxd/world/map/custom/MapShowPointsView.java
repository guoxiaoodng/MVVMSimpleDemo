package com.gxd.world.map.custom;
...
import com.gxd.world.map.R;
import com.gxd.world.map.bean.MapShowPointsViewPointBean;
import com.gxd.world.map.bean.PointTypeEnum;
...
public class MapShowPointsView extends FrameLayout implements View.OnClickListener {
    ...
    public interface MapShowPointsViewListening {
         ...
         * 地图加载成功
         */
        void onTheCodingListener(ReverseGeoCodeResult result, boolean isInGrid);
    }
    ...
    private void initMapView() {
        try {
            ...
            if (showLocaing) {
                ...
                mCoder.setOnGetGeoCodeResultListener(myOnGetGeoCoderResultListener);
                if (clickable) {
...
//                        map.showInfoWindow(infoWindow);
                ...
                if (listening != null) {
                    listening.onTheCodingListener(result, pointInGrid(result.getLocation(), mLatLngs));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
