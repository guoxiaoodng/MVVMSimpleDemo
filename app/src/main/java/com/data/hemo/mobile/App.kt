...
import com.data.hemo.mobile.BR
import com.data.hemo.mobile.BuildConfig
import com.data.hemo.mobile.works.RenameWorkerFactory
import com.data.mobile.net.AppCacheManager
import com.data.mobile.net.constance.http.HttpParamConst
import com.data.mobile.net.converter.GsonConverter
import com.data.mobile.resouce.config.FakeCrashLibrary
import com.data.mobile.resouce.dialog.LoadingDialog
...
//        SkyEngineKit.init(VoipEvent())
    ...
    private fun initGlide() {
        com.data.hemo.mobile.glide.ImageLoader.getDefault().diskCacheOptions()
