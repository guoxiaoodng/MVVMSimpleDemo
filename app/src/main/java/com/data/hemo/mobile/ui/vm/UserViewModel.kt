package com.data.hemo.mobile.ui.vm
...
import com.data.hemo.mobile.databinding.FragmentLoginBinding
import com.data.mobile.net.AppCacheManager
import com.data.mobile.net.bean.GlobalUserInfoBean
import com.data.mobile.net.bean.LoginBean
