...
class MainActivity : BaseActivity<ActivityMainBinding>(R.layout.activity_main) {
    ...
    private fun setupViews() {
        binding.btnGenerate.setOnClickListener {
            if (!com.gk.world.comprehensive.utils.NetworkUtils.isWifiConnected(this)) {
                showWifiWarning()
    ...
    private fun updateNetworkStatus() {
        binding.tvNetworkStatus.text = com.gk.world.comprehensive.utils.NetworkUtils.getNetworkInfo(this)
