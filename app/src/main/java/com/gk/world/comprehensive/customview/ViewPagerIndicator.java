package com.gk.world.comprehensive.customview;
...
public class ViewPagerIndicator extends View {
     ...
     * @return
     */
    public ViewPagerIndicator setViewPager2(ViewPager2 viewPager) {
        setViewPager2(viewPager, viewPager.getAdapter().getItemCount(), false);
        return this;
    }
   ...
   /**
     ...
     * @return
     */
    public ViewPagerIndicator setViewPager2(ViewPager2 viewpager, int CycleNumber, boolean isInfiniteCircle) {
        mNum = CycleNumber;
        mIsInfiniteCircle = isInfiniteCircle;
