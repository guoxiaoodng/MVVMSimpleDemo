...
import com.gk.world.comprehensive.works.Constants;
...
public class TimeUtil {
    ...
    public static long StringToLong(String time) {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat(Constants.YMDHM, Locale.CHINA);
    ...
    public static String LongToString(long time) {
        try {
            ...
            SimpleDateFormat sdf = new SimpleDateFormat(Constants.YMDHMS, Locale.CHINA);
    ...
    public static int compareDate(String nowDate, String startDate, String endDate) {
        SimpleDateFormat df = new SimpleDateFormat(Constants.YMDHMS1, Locale.CHINA);
